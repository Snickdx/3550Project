	...
	$(document).ready(function () {
		...
		$(document).on("submit", "#addUsageForm", function () {
			...
			if (validateUsage(date, time, comp) === true) {
				...
				$("#addResponse").html("<p>Incorrect Input!</p>");
				$("#addResponse").show();
				return false;
			}
			return false;
