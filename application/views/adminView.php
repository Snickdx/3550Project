		...
		<div class="row tab-content">
			...
			<!--Database Tab Content--><div id="database" class="tab-pane fade col-md-12" >
				...
				<ul class="well stdheight col-md-2 col-xs-offset-1 nav nav-stacked">
					...
					<li>
						<a class="btn btn-default btn-lg " href="#altbl" data-toggle="tab">Access Table</a>
					</li><br>
				</ul>
				<div class="tab-content col-md-10 col-xs-offset-1">
					...
					<div class="tab-pane stdheight well fade in active" id="memtbl">
						<div id="sec3">
								...
								<div id="addForm2">
									<form id="addUserForm" class="form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-xs-5">
												<input type="text" class="form-control" id="addUserPass" name="addUserPass" required/>
											</div>
										</div>
										<div class="form-group">
							...
							<div class="sec2" id="editRec2">
								<h2>Edit User</h2>
								<form id="editUserForm2" class="form-horizontal">
									<div class="form-group">
